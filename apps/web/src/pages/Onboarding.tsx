    ...
    return (
      <div className="min-h-screen p-6 bg-white">
        ...
        <button
          ...
          className="w-full bg-blue-500 text-white py-4 rounded-2xl font-medium text-lg disabled:opacity-40"
        >
  ...
  return (
    <div className="min-h-screen p-6 bg-white">
      ...
      <button
        ...
        className="w-full bg-green-500 text-white py-4 rounded-2xl font-medium text-lg disabled:opacity-40"
      >
